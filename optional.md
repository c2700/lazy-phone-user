...
#### battery_audio.json.ref reference
* min & max keys in the non_terminal_lvls array's dict.s are to set a certain battery range. eg: min - 5, max - 10 (range from 5-10), next range is min - 11, max - 20 (range from 11-20)
* "full battery", "battery_down" - array of file paths to randomly choose from for when battery is at zero or full

        {
            ...
            "non_terminal_lvls":[
                {
                    "min": <minimum Battery percentage>,
                    "max": <minimum Battery percentage>,
                    "charging_audio": "<audio file path>",
                    "discharging_audio": "<audio file path>",
                    "power_in_event_audio": "<audio file path>",
                    "power_removed_event_audio": "<audio file path>"
                },
            ]
        }
